...
<body style="margin: 0; padding: 0; background-color: #fbf7e1; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 560px; margin: 0 auto; padding: 40px 20px;">
    <!-- Header -->
    <div style="text-align: center; margin-bottom: 32px;">
      <div style="font-size: 18px; font-weight: 700; color: #160905; letter-spacing: -0.3px;">დასაქმდი</div>
    </div>
    ...
    <div style="background: #fffefa; border-radius: 12px; border: 1px solid #e8e0c8; padding: 24px 24px 8px; box-shadow: 0 1px 2px rgba(0,0,0,0.04);">
      ...
      <div style="text-align: center; padding: 24px 0 16px;">
        <a href="${SITE_URL}/jobs" style="display: inline-block; background: linear-gradient(135deg, #f5ebb4, #C7AE6A); color: #160905; font-size: 13px; font-weight: 600; padding: 10px 24px; border-radius: 8px; text-decoration: none;">
          ${s.viewAll}
        </a>
      </div>
    </div>
    ...
    <!-- Footer -->
    <div style="text-align: center; padding: 24px 0; font-size: 11px; color: #725252;">
      <div>${s.footer}</div>
      <a href="${unsubscribeUrl}" style="color: #725252; text-decoration: underline; margin-top: 4px; display: inline-block;">
        ${s.unsubscribe}
      </a>
    </div>
  </div>
